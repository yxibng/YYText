...
- (void)viewDidLoad {
    ...
    label.height = self.view.height - (kiOS7Later ? self.navigationHeight : 44);
    label.top = (kiOS7Later ? self.navigationHeight : 0);
...
- (void)showMessage:(NSString *)msg {
    ...
    label.bottom = (kiOS7Later ? self.navigationHeight : 0);
    [self.view addSubview:label];
